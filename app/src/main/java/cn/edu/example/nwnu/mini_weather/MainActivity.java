...
import cn.edu.example.nwnu.bean.TodayWeather;
import cn.eud.example.nwnu.util.NetUtil;
...
public class MainActivity extends Activity implements View.OnClickListener {
    ...
    public void onClick(View view) {
        ...
        if (view.getId() == R.id.title_update_btn) {
            ...
            String cityCode = sharedPreferences.getString("main_city_code", "101080201");
